...
public class fnTrain {
    ...
    /**
     * TrainingContext inner class - encapsulates all training state and configuration
     * Used for multi-threaded training and distributed experiments
     */
    public static class TrainingContext {
        ...
        public int[] studentConfig;
        public int replication;
        public int studentIdx;
        
        // Training parameters
        public String optimizerType;  // "ADAM", "RMSPROP", or "L2"
        public double learningRate;
        public double l2Lambda;
        public double adamBeta1;
        public double adamBeta2;
        ...
        // State tracking
        public network teacherNetwork;
        public network studentNetwork;
        public boolean useTeacher;  // true if teacher-guided, false if standalone
        ...
        /**
         * Constructor for standalone student training (no teacher)
         */
        public TrainingContext(double[][] inputs, double[][] targets,
                              double[][] inputsValidate, double[][] targetsValidate,
                              int inputSize, int outputSize, int numSamples,
                              double skipPercentage, int[] studentConfig,
                              int replication, int studentIdx,
                              String optimizerType, double learningRate,
                              double l2Lambda, double adamBeta1, double adamBeta2,
                              double rmspropDecay, int numEpochs,
            ...
            this.trainingLoss = new double[numEpochs];
            this.validationLoss = new double[numEpochs];
            this.trainingAccuracy = new double[numEpochs];
            this.validationAccuracy = new double[numEpochs];
        }
        
        /**
         * Constructor for teacher-guided student training
         */
        public TrainingContext(double[][] inputs, double[][] targets,
                              double[][] inputsValidate, double[][] targetsValidate,
                              int inputSize, int outputSize, int numSamples,
            ...
            this(inputs, targets, inputsValidate, targetsValidate,
                 inputSize, outputSize, numSamples, skipPercentage, studentConfig,
                 replication, studentIdx, optimizerType, learningRate, l2Lambda,
                 adamBeta1, adamBeta2, rmspropDecay, numEpochs, baseDirectoryPath);
            this.teacherNetwork = teacherNetwork;
        ...
        public String toString() {
            return String.format(
                "TrainingContext{" +
                "Config=%s, Skip=%.2f, Optimizer=%s, LR=%.6f, " +
                "L2=%.6f, Replication=%d, StudentIdx=%d}",
                java.util.Arrays.toString(studentConfig), skipPercentage,
                optimizerType, learningRate, l2Lambda, replication, studentIdx
            );
        }
    }
